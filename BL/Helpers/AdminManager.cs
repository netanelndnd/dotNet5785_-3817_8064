...
internal static class AdminManager //stage 4
{
    ...
    internal static void UpdateClock(DateTime newClock) //stage 4-7
    {
        ...
        if (_periodicTask is null || _periodicTask.IsCompleted) //stage 7
            _periodicTask = Task.Run(() => AssignmentManager.CheckAndExpireAssignments());
    ...
    private static void clockRunner()
    {
        while (!s_stop)
        {
            ...
            if (_simulateTask is null || _simulateTask.IsCompleted)//stage 7
                _simulateTask = Task.Run(() => AssignmentManager.CheckAndExpireAssignments());
...
//    /// Property for providing/setting current configuration variable value for any BL class that may need it
//    /// </summary>
//    internal static void Reset() //stage 4
//    {
//       s_dal.Config.Reset();
//       ConfigUpdatedObservers?.Invoke(); // stage 5
//    }

//    internal static TimeSpan RiskRange //stage 4
//    {
//        get => s_dal.Config.RiskRange;
//        set
//        {
